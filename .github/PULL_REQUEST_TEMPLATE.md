...
<!--
Behaviour differs across harness versions and across Windows / Linux. An untested
axis is worth naming rather than assuming — say which ones you did not cover.
This project has been booted against dsh 0.1.5-rc.2 only.
-->
...
- [ ] Nothing in the "Never break these" list of [`AGENTS.md`](AGENTS.md) is violated
