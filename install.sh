...
echo ""
echo "Installed. The bundle patch in this package already covers host-plane"
echo "sessions: it disables the host compaction-basic row and puts this engine in"
echo "its place."
echo ""
echo "Agent sessions need one more step, because a profile patch cannot reach an"
echo "agent preset realm. In your preset's agent.cordis.yml, inside the group"
echo "declared isolate: { compaction: true, ... }, replace the row"
echo ""
